...
class RapotUtsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $activities = Activity::where('subject_type', 'App\\RapotUts')->get();
        ...
        if (!$request->has('kelas')) {
            return view('rapot-uts.index', compact('kelasList', 'activities'));
        }
        ...
        if ($view === 'kelas') {
            ...
            if (!$request->has('mapel')) {
                return view('rapot-uts.index', compact('kelasList', 'kelas', 'mapelList', 'activities'));
            }
            ...
            return view('rapot-uts.index', compact('kelasList', 'kelas', 'mapelList', 'mapel', 'guru', 'activities'));
        } else if ($view === 'siswa') {
            if (!$request->has('siswa')) {
                return view('rapot-uts.index', compact('kelasList', 'kelas', 'activities'));
            }
            ...
            return view('rapot-uts.index', compact('kelasList', 'kelas', 'siswa', 'mapels', 'activities'));
        }
    }
